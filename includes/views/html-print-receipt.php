...
<head>
    ...
    <style>
        ...
        body.pos_receipt, table.order-info, table.receipt_items, table.customer-info, #pos_receipt_title, #pos_receipt_address, #pos_receipt_contact, #pos_receipt_header, #pos_receipt_footer, #pos_receipt_tax, #pos_receipt_info, #pos_receipt_items, pos_receipt_tax_breakdown, table.tax_breakdown, #pos_receipt_wifi, .display-socials {
            ...
            foreach ($items as $item_id =>  $item) {
                ...
                <tr>
                    ...
                    <td class="product-name">
                        <strong><?php echo $name = esc_html($_product->get_title()); ?></strong>
