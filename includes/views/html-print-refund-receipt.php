...
<head>
    <meta charset="utf-8">
    <title><?php _e('Refund', 'woocommerce-point-of-sale'); ?></title>
    <style>
        @media print {
...
for ($rc = 1;
    ...
    <div id="pos_receipt_title">
        <?php echo __("Refund Receipt", "wc_point_of_sale"); ?>
    </div>
            ...
            <?php if ($receipt_options['print_order_time'] == 'yes') { ?>
                <tr>
                    ...
                    <td><?php if ($receipt_options['order_date_label']) {
                            ...
                            echo $refund->get_date_created()->date_i18n($format); ?>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
                    ...
                    <td class="product-price">
                        ...
                        if ($receipt_options['show_cost'] == 'yes') {
                            ...
                            if (isset($item['line_total'])) {
                                echo wc_price($price, array('currency' => $order->get_currency()));
                            }
                        }
                        ?>
                    </td>
            ...
            if (($totals = $refund->get_order_item_totals())) {
                ...
                foreach ($totals as $total_key => $total) :
                    switch ($total_key) {
                        case 'cart_subtotal':
                            ...
                            break;
                        case 'tax':
                            $total_label = __('Tax', 'wc_point_of_sale');
                            break;
                        case 'order_total':
                ...
                <?php if ($preview || $receipt_options['print_number_items'] == 'yes') { ?>
                    <tr id="print_number_items">
                        ...
                        <td>
                            <?php echo $refund->get_item_count(); ?>
                        </td>
                    </tr>
                <?php } ?>
            <?php } ?>
