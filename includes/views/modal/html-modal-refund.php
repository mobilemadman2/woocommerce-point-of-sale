        ...
        jQuery(document).ready(function($){
            ...
            $("#load_refund_products").on('click', function (e) {
                ...
                $("#barcode_options_table tbody tr").each(function(i, el){
                    ...
                    item_data.total = (item_data.total - (item_data.total * 2)).toFixed(2);
                    item_data.total_tax = (item_data.total_tax - (item_data.total_tax * 2)).toFixed(2);
            ...
            function filter_order(order_id){
                ...
                APP.db.get('orders', order_id).done(function(order){
                    if(order){
                        ...
                        $.when(APP.getServerOrders('', order_id)).then(function (orders) {
                            if( orders.length > 0 ) {
