...
#	        add_action( 'wp_login', array( $this, 'set_last_login') );
    ...
    public function wc_api_loaded()
    {
        ...
        include_once('api/class-wc-pos-api-order-refunds.php');
    ...
    public function footer()
    {
        ...
        $scripts = array(
            ...
            'wc-pos-vue' => 'https://cdn.jsdelivr.net/npm/vue/dist/vue.js',
            'wc-pos-vuex' => 'https://cdn.jsdelivr.net/npm/vuex/dist/vuex.js',
            /********/
        );
        ...
        if (get_option('wc_pos_enable_new_api', 'no') == 'no') {
            ...
            $scripts['wc-pos-app-vue'] = WC_POS()->plugin_url() . '/assets/js/register/app-vue.js';
...
//            'wc_api_url' => home_url('wp-json/wc/v2/'),
            ...
            'disable_customers_cache' => get_option('wc_pos_disable_customers_cache', 'yes'),
...
//        WC()->product_factory->get_product();
    ...
    public function getGrid($is_api = false)
    {
            ...
            if (count($tiles)) {
                foreach ($tiles as $key => $style) {
                    ...
                    if($style->style == "auto"){
                        ...
                        $product_ids = $wpdb->get_col("SELECT object_id FROM {$wpdb->prefix}term_relationships WHERE term_taxonomy_id = {$cat->term_id}");
                        $products = array_merge($products, $product_ids);
                    }else{
                        $products[] = $style->product_id;
                    }
        ...
        $tile_limit = get_option('wc_pos_product_limit', 100);
        $grid = array(
            ...
            'tile_limit' => !empty($tile_limit) ? (int)$tile_limit : 100
        );
