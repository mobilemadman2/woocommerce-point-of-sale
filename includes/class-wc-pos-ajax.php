...
// Store variation data in meta
    ...
    public function change_stock()
    {
        ...
        if ($product_id) {
            ...
            if ($operation == 'increase') {
                ...
                $stock = $value;
                $note .=  '<strong>' . $product->get_name() . '</strong>' . __(' stock replaced by ', 'wc_point_of_sale') . $value;
            } else {
                $stock -= $value;
                if ($stock < 0) {
                    $stock = 0;
    ...
    public function force_register()
    {
        ...
        $session_id = pos_close_register($_POST['register_id'], true);
        pos_set_register_lock($_POST['register_id']);
