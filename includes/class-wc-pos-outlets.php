...
class WC_Pos_Outlets
{
    ...
    public function init_form_fields($country = '')
    {
        ...
        $this->outlet_address_fields['wifi_network'] = array(
            'label' => __('Wi-Fi Network', 'wo_point_of_sale'),
            'type' => 'text'
        );
        $this->outlet_address_fields['wifi_password'] = array(
            'label' => __('Wi-Fi Password', 'wo_point_of_sale'),
            'type' => 'text'
        );
