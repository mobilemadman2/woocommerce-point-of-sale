		...
		<div class="wrap nosubsub">
		    ...
		    <div id="col-container">
		    	...
		    	<div id="col-left">
		    		<div class="col-wrap">
		    			<div class="form-wrap">
		    				<h2><?php _e( 'Add New Product Grid', 'wc_point_of_sale' ) ?></h2>
		    				<p><?php _e( 'Product grids lets you define the products that you want to show on each register. Using tiles which represent a product, you can customise the product grid layout.', 'wc_point_of_sale' ) ?></p>
