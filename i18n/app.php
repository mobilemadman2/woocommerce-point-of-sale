...
return array(
    ...
    46 => __('Chose tab', 'wc_point_of_sale'),
    47 => __('Spend limit for this tab %s', 'wc_point_of_sale'),
    48 => __('You are about to close this register. All sales will be logged for this session.', 'wc_point_of_sale'),
    49 => __('This tab already opened', 'wc_point_of_sale'),
    50 => __('Opened', 'wc_point_of_sale'),
    51 => __('Available', 'wc_point_of_sale'),
    52 => __('Minimum title length 3 symbols', 'wc_point_of_sale'),
    53 => __('Discount', 'wc_point_of_sale'),
    54 => __('Add customer', 'wc_point_of_sale'),
    55 => __('Save customer', 'wc_point_of_sale'),
    56 => __('Sign is required', 'wc_point_of_sale')
);
